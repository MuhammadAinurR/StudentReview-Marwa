...
if selected == "About":
    ...
    st.write(
        ...
        "As we embrace the Color of the Year, it becomes more than just a shade on the color spectrum;"
        ...
        "This color trend is not merely a reflection of aesthetics but"
        "a visual language that connects us to the evolving dynamics of our world. Whether it's a calming hue that promotes tranquility or a bold"
        "shade that sparks energy, the Color of the Year is a powerful force that transcends its visual appeal. It serves as a cultural marker, "
    ...
    Cyears = st.selectbox("Color Trends: ", ["2021", "2020", "2019", "2018", "2017"])
    # Color Information
    # print the trend of the years
    ...
    st.text("fashion colors for the year: ")
